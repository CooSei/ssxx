...
def get_content(url,my_name,my_index):
	...
	with open(my_name+'.txt','a') as f:
		for l in question_id:
			url3 = 'https://ssxx.univs.cn/cgi-bin/race/question/?t='+this_time+'&activity_id=5f71e934bcdbf3a8c3ba5061&question_id='+l+'&mode_id='+my_index
	...
	for i in range(4):
		...
		while 1:
			...
			try:
				...
				time.sleep(10)
		write_log()
		# os.system('shutdown -s -t 120')  #完成后关机
