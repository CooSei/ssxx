...
import json,time,os
try:
	all_ids = json.load(open('创新id.txt','r'))
	all_answer_id = json.load(open('创新answer_id.txt','r'))
	scores = json.load(open('创新score.txt','r'))
except:
	all_ids = []
	all_answer_id = []
	scores = []
...
test = 0
strit = 0
size_1 = os.path.getsize('创新.txt')
while 1:
	if strit>500:
		break
	strit += 1
	size_2 = os.path.getsize('创新.txt')
	time.sleep(5)
	try:
		...
		token = ll['token']
		url2 = 'https://ssxx.univs.cn/cgi-bin/race/beginning/?t='+this_time+'&activity_id=5f71e934bcdbf3a8c3ba5061&mode_id=5f71e934bcdbf3a8c3ba51d7&way=1'
		headers['Authorization'] = 'Bearer '+token
		response = requests.get(url2,headers=headers)
		question = json.loads(response.text)
		question_id = question['question_ids']
		race_code = question['race_code']
		headers['Referer'] = 'https://ssxx.univs.cn/client/exam/5f71e934bcdbf3a8c3ba5061/1/1/5f71e934bcdbf3a8c3ba51d7'
		every_score = 0
		with open('创新.txt','a') as f:
			for l in question_id:
				url3 = 'https://ssxx.univs.cn/cgi-bin/race/question/?t='+this_time+'&activity_id=5f71e934bcdbf3a8c3ba5061&question_id='+l+'&mode_id=5f71e934bcdbf3a8c3ba51d7'
		...
		print(99999)
		time.sleep(10)
file = open('创新id.txt','w')
file.write(json.dumps(all_ids))
file.close()
file = open('创新answer_id.txt','w')
file.write(json.dumps(all_answer_id))
file.close()
file = open('创新score.txt','w')
